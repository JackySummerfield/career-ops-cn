...
Usage:
    python util/gen_dashboard.py --user JackyTao
    python util/gen_dashboard.py --user JackyTao --output dashboard.html
    python util/gen_dashboard.py --user JackyTao --vscode   # add VS Code URIs
